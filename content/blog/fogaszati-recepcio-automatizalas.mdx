...
<Scene>
  Délelőtt tíz óra, a kezelőben épp egy beavatkozás zajlik. A telefon csörögni
  kezd. A recepciós másik hívással foglalkozik, az asszisztens kesztyűben áll a
  szék mellett. A hívás kicseng. A vonal másik végén egy új páciens volt, aki
  fogfájással keresett rendelőt — és aki a következő találatot tárcsázza, ahol
  felveszik.
</Scene>
...
<StatCallout source="szisztematikus szakirodalmi áttekintés (Health Policy, 2018); emlékeztetőkre vonatkozó randomizált kontrollált vizsgálat — hivatkozások a cikkben.">
  Európában a fogorvosi és orvosi időpontoknál a meg nem jelenés aránya
  átlagosan nagyjából **19%** — vagyis durván minden ötödik foglalt időpont
  elmarad. Egy randomizált vizsgálatban a megfelelő emlékeztetők ezt az arányt
  24%-ról 14%-ra csökkentették.
</StatCallout>
...
<InlineCta href="/ajanlat/fogaszat">
  Hány hívás cseng ki Önnél kezelés közben? Mérjük meg együtt.
</InlineCta>
