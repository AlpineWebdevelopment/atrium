...
const EXAMPLES: { ico: IconKey; t: string; d: string; who: string; c: string }[] = [
  {
    ...
    d: "Az új megkeresések felkutatása ma elaprózódik. Valaki cégadatbázisokat és nyilvános listákat néz át, amikor épp jut rá ideje. A rendszer folyamatosan keresi a profilba illő cégeket, rangsorolja őket aszerint, mennyire ígéretesek, és előkészíti a megszólításukat. Ön rangsorolt listával kezdi a hetet, nem üres táblázattal.",
  ...
  },
  {
    ...
    d: "Hogy hol áll egy weboldal a keresőben, az ma kézi munka: oldalankénti átnézés, kulcsszavak, hiányzó leírások. A rendszer rendszeresen átfésüli az oldalakat, kigyűjti a gyenge pontokat, és kész kimutatást küld arról, mit érdemes javítani. Egy szakember így sokszorta több oldalt tart kézben, mint kézzel valaha.",
  ...
  },
  {
    ...
    d: "Ahol több ezer akta gyűlt fel, ott egy konkrét adat előkeresése hosszú perceket visz el. A rendszer az egész iratanyagból megtalálja és kiemeli a keresett részt, és megmutatja, melyik dokumentumból való. A válasz pár másodperc alatt megvan — a forrással együtt.",
  ...
  },
  {
    ...
    d: "A más nyelven író ügyfél kérdése ma kivár, amíg valaki, aki bírja a nyelvet, rá tud nézni. A rendszer a beérkező üzenetet az ügyfél nyelvén fogadja, a belső adatokból válaszol a tipikus kérdésekre, a többit pedig lefordítva a munkatárs elé teszi. A válasz nem lassul le, és nem köt le külön embert.",
  ...
  },
  {
    ...
    d: "A hideg megkeresés ma az értékesítő idejének javát elviszi, és a próbálkozások nagy része nem vezet sehová. A rendszer személyre szabott első üzeneteket állít össze, követi a beérkező reakciókat, és csak a ténylegesen érdeklődő kapcsolatot adja át a kollégának. Az értékesítő a komoly lehetőségekkel foglalkozik, nem a hideg névsorral.",
  ...
  },
  {
    ...
    d: "A heti és havi összefoglalók ma több forrásból, kézzel állnak össze — újra meg újra. A rendszer összeszedi az adatot, megírja a kész kimutatást, és határidőre eljuttatja annak, akinek szól. Ugyanaz a tartalom, csak nem megy el rá a fél nap.",
  ...
  },
  {
    ...
    d: "Az ügyfél-nyilvántartás, a számlázó és a naptár ma külön szigeteken áll, és valaki kézzel viszi át köztük az adatot. Időnként elcsúszik, időnként kimarad. A rendszer a háttérben tartja egyben a hármat, és szól, ha valami nem stimmel. Egy teljes, ismétlődő gépelős feladat kerül le a napról.",
  ...
  },
  {
    ...
    d: "A gond ma többnyire akkor látszik meg, amikor már baj van belőle: a kiesett rendelés, a megakadt szállítmány, a számla, ami utólag kerül elő. A rendszer figyeli a szokásos menetet, és időben jelez, ha valami kilóg belőle. A hibát nem a megrendelő veszi észre elsőként.",
