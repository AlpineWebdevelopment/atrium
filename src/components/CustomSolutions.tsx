...
const PILLARS: {
...
}[] = [
  {
    acc: "#7C5CFF",
    eyebrow: "Csomagok",
    h: "Akkora rendszer, amekkorára szüksége van.",
    d: "Egyfős rendelő vagy országos hálózat — a felépítés és az ár is a cégéhez igazodik.",
    items: [
      "Egyszeri beállítás: 100 000 és 4 000 000 Ft között",
      "Havidíj: 40 000 és 1 500 000 Ft között",
      "A saját CRM-jébe kötve, kivétel nélkül",
      "Folyamatos felügyelet, éjjel-nappal",
    ],
    Gfx: GfxTiers,
  },
  {
    acc: "#4AA3FF",
    eyebrow: "A motor",
    h: "Egy fejlett rendszer, végig a háttérben.",
    d: "Hét csatornán ugyanaz az emlékezet és ugyanaz a tempó — fennakadás nélkül.",
    items: [
      "Közös, kifogyhatatlan memória — egyetlen szálat sem ejt el",
      "Magától is megkeres és visszahív, nem csak válaszol",
      "Élethű, folyékony magyar beszéd",
      "Telefon, SMS, WhatsApp, Messenger, Instagram, e-mail és webchat",
      "Magától viszi a folyamatot, és szól, amikor kell",
      "Az Ön CRM-je azonnal frissül",
    ],
    Gfx: GfxChannels,
  },
  {
    acc: "#34C759",
    eyebrow: "Az eredmény",
    h: "Az számít, ami a számláján látszik.",
    d: "Se látványos kütyük, se egyszerű botok — egyetlen mérce van: mennyivel hoz többet.",
    items: [
      "Kézzelfogható üzleti gondokra, nem bemutatóra",
      "Több megkeresés, több foglalás, nagyobb bevétel",
      "Az ára pár hónap alatt megtérül, nem évek alatt",
      "Számokban kimutatható növekedés, nem ígéret",
    ],
    Gfx: GfxRoi,
  },
  {
    ...
    h: "Egy képernyő, és mindent lát.",
    d: "Beszélgetések, ügynökök, eredmények — együtt, élőben, kéznél.",
    items: [
      "Bármelyik beszélgetés visszanézhető és elemezhető",
      "Élő számok és teljesítménymutatók egy nézetben",
      "Az összes AI-ügynök egy helyről vezérelve",
      "Zsebben is — mobilalkalmazással",
    ],
    Gfx: GfxDash,
  },
];
