...
const EXAMPLES: { ico: IconKey; t: string; d: string; who: string; c: string }[] = [
  {
    ...
    d: "Az új megkeresések felkutatása ma elaprózódik: valaki cégadatbázisokat, weboldal-érdeklődőket és nyilvános listákat néz át, amikor épp jut rá idő. A rendszer folyamatosan keresi a profilba illő cégeket, rangsorolja őket aszerint, mennyire ígéretesek, és előkészíti a megszólításukat. Ön a kész, rangsorolt listával kezdi a hetet, nem az üres táblázattal.",
  ...
  },
  {
    ...
    d: "Hogy hol áll a saját vagy egy ügyfél weboldala a keresőben, az ma kézi munka: oldalankénti átnézés, kulcsszavak, hiányzó leírások, havi kimutatás. A rendszer rendszeresen átfésüli az oldalakat, kigyűjti a gyenge pontokat, javaslatot ad a szövegekre és a beállításokra, majd kész kimutatást küld. Egy szakember így sokszorosabb oldalt tart kézben, mint kézzel valaha.",
  ...
  },
  {
    ...
    d: "Ahol több ezer akta gyűlt fel, ott egy konkrét adat előkeresése hosszú percek, néha negyedóra — valaki mappákat, szerződéseket, korábbi ügyeket lapoz át. A rendszer az egész iratanyagból megtalálja és kiemeli a keresett részt, és megmutatja, melyik dokumentumból való. A válasz pár másodperc alatt megvan, a forrással együtt.",
  ...
  },
  {
    ...
    d: "A más nyelven író ügyfél kérdése ma kivár, amíg valaki, aki bírja a nyelvét, rá tud nézni. A rendszer a beérkező üzenetet az ügyfél nyelvén fogadja, a belső adatokból válaszol a tipikus kérdésekre, a többit pedig lefordítva a munkatárs elé teszi. A nyelv nem lassítja le a választ, és nem igényel külön embert.",
  ...
  },
  {
    ...
    d: "A hideg megkeresés ma az értékesítő idejének javát elviszi, és a próbálkozások nagy része nem vezet sehová. A rendszer személyre szabott első üzeneteket állít össze, követi a beérkező reakciókat, és csak az ténylegesen érdeklődő kapcsolatot adja át a kollégának. Az értékesítő a komoly lehetőségekkel foglalkozik, nem a hideg névsorral.",
  ...
  },
  {
    ...
    d: "A heti és havi kimutatások, a vezetőnek vagy az ügyfélnek szóló összefoglalók ma több forrásból, kézzel állnak össze — újra meg újra. A rendszer összeszedi az adatot, megírja a kész kimutatást, és határidőre eljuttatja annak, akinek szól. Ugyanaz a tartalom, csak nem megy el rá a fél nap.",
  ...
  },
  {
    ...
    d: "Az ügyfél-nyilvántartás, a számlázó és a naptár ma külön szigeteken él, és valaki kézzel viszi át köztük az adatot — időnként elcsúszik vagy kimarad. A rendszer a háttérben tartja egyben a hármat, és szól, ha valami nem stimmel. Egy teljes, ismétlődő gépelős feladat kerül le a napról, tévesztés nélkül.",
  ...
  },
  {
    ...
    d: "A gond ma többnyire akkor lesz láthatóvá, amikor már baj van belőle — a kiesett rendelés, a megakadt szállítmány, a lejárt számla utólag kerül elő. A rendszer figyeli a szokásos menetet, és időben jelez, ha valami kilóg belőle. A hibát nem a megrendelő veszi észre elsőként.",
