...
const PILLARS: {
  ...
  },
  {
    ...
    items: [
      "Közös, kifogyhatatlan memória mind a hét csatornán — semmit sem felejt",
      "Magától megkeres, visszahív és viszi a folyamatot",
      "Élethű, folyékony magyar beszéd",
      "Az Ön CRM-jét valós időben frissíti",
    ],
    Gfx: GfxChannels,
  },
  {
