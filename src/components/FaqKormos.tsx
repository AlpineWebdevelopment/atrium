...
const FAQS = [
  ...
  },
  {
    ...
    /* ATRIUM-EDIT NR5-kormos-Q2 — reframe call-answering answer to DM-booking core */
    a: "Igen — pontosan erre terveztük. Manikűr, pedikűr, géllakkozás közben a rendszer megválaszolja a Messengeren és Instagramon érkező foglalási kéréseket, időpontot kínál a naptárából, és visszaigazolja a foglalást. Ön dolgozik, a rendszer foglal.",
  },
  {
  ...
  },
  {
    ...
    /* ATRIUM-EDIT NR5-kormos-Q6 — reframe call-volume answer to DM-booking core */
