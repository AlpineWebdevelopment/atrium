/* ATRIUM-EDIT KV10 — 5 Q&As rebuilt for cégvezető napelem (solar) buyer.
   Key change: "Új ügyfeleket is szerez?" → honest "Nem." answer about existing demand.
...
export default function FaqNapelem() {
