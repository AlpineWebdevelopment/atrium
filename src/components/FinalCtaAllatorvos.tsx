/* ATRIUM-EDIT AV12 — vet final CTA.
   Opens on the hidden lever: pending vaccination drift in the base.
   No fabricated figures. Button: Foglaljon időpontot (consistent site-wide). */

export default function FinalCtaAllatorvos() {
  return (
      ...
      <div className="wrap">
        <div className="final-cta__panel reveal">
          ...
          <h2 className="final-cta__h">
            Tudja, hány páciense csúszott le az oltási rendről?
          </h2>
          <p className="final-cta__p">
            30 perces megbeszélés. Megnézzük, hány aktív páciense van, és hányan
            maradtak le az oltásról vagy a szűrésről, majd megmutatjuk, mennyit
            hoz vissza ebből a rendszer, mielőtt bármiről dönt.
          </p>
