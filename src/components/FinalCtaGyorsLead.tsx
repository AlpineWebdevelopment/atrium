/* ATRIUM-EDIT LR10 — lead-response service final CTA.
   Hook: "Nézzük meg, hány lead veszett el az elmúlt hónapban."
   Consistent button: Foglaljon időpontot. */

export default function FinalCtaGyorsLead() {
  return (
    <section className="final-cta" id="kapcsolat">
      <div className="wrap">
        <div className="final-cta__panel reveal">
          {/* ATRIUM-EDIT LR10 */}
          <h2 className="final-cta__h">Nézzük meg, hány lead veszett el az elmúlt hónapban.</h2>
