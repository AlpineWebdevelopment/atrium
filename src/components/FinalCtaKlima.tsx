/* ATRIUM-EDIT KV11 — cégvezető klíma final CTA rebuild.
   KV11 heading: heatwave-peak missed calls + pending quotes as the hook.
   Body: 30 perces megbeszélés framing.
   Button: Foglaljon időpontot (consistent with Hero).
   KV12 trust strip repeated here. */

export default function FinalCtaKlima() {
  return (
