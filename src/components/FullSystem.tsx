...
const PHASES = [
  {
    ...
    steps: [
      ...
      { ic: "chat", t: "Azonnali utánkövetés", s: "a webes, Instagram- vagy Viber-érdeklődőt is percek alatt felhívja" },
      { ic: "qualify", t: "Minősítés", s: "felteszi a fontos kérdéseket, és minősíti az érdeklődőt" },
      { ic: "chat", t: "Válaszadás", s: "a gyakori kérdésekre azonnal válaszol, a cég saját anyagaiból" },
  ...
  },
  {
    ...
    steps: [
      ...
      { ic: "confirm", t: "Visszaigazolás", s: "azonnal visszaigazolja az időpontot" },
      { ic: "bell", t: "Emlékeztető", s: "időben szól, hogy az időpont ne maradjon el" },
      { ic: "reschedule", t: "Átütemezés", s: "ha valaki lemond vagy nem jelenik meg, a rendszer visszahív, és új időpontot egyeztet" },
    ],
  },
  {
