/* ATRIUM-EDIT KV5/KV6 — full system rebuilt for cégvezető construction buyer.
   ...
   CAPS: 6 construction capabilities, unchanged from previous build. */
...
/* KV5 — three phases, construction-specific */
const PHASES: {
...
}[] = [
  {
    ...
    steps: [
      { ic: "phone",   t: "Azonnali fogadás",   s: "minden megkeresést fogad: hívás, webűrlap, e-mail — csúcsterhelésen és munkaidőn túl is, professzionális magyar nyelven" },
      { ic: "qualify", t: "Kvalifikálás",        s: "projekt típusa, mérete, helyszín, költségvetési jelzés, határidő, komolyság — és aszerint szűr, milyen munkát keres a cég" },
      { ic: "users",   t: "Szűrés",             s: "a nem komoly, rossz illeszkedésű megkeresés nem ér el a kalkulátorokig" },
      { ic: "handoff", t: "Élő átadás",          s: "a kalkulátor vagy projektvezető csak valós, előszűrt lehetőséget kap" },
    ],
  },
  {
    n: "02", name: "Irányítás és foglalás", cap: "a megfelelő emberhez, időponttal megerősítve", c: "#628FBC", Viz: VizIranyitas,
    steps: [
      { ic: "handoff",  t: "Irányítás",            s: "a kvalifikált megkeresést a megfelelő emberhez küldi, a részletekkel együtt, hogy a drága emberek csak valós, rendezett lehetőséget kapjanak" },
      { ic: "calendar", t: "Felmérés foglalása",   s: "a helyszíni felmérést a naptárba teszi, és visszaigazolja az ügyfélnek" },
      { ic: "confirm",  t: "Visszaigazolás",        s: "azonnal visszaigazolja a foglalást az ügyfélnek" },
      { ic: "bell",     t: "Emlékeztető",           s: "emlékezteti a megbízót a helyszíni felmérés előtt" },
    ],
  },
  {
    n: "03", name: "Lezárás és rálátás", cap: "utánkövetéstől a teljes képig", c: "#6DBC61", Viz: VizRalatas,
    steps: [
      { ic: "send",     t: "Árajánlat-utánkövetés",              s: "minden kiküldött ajánlatot szisztematikusan utánkövet, amíg az ügyfél nem válaszol vagy el nem utasít — semmi nem marad el azért, mert egy projektvezető épp elfoglalt volt" },
      { ic: "callback", t: "Túlcsordulás és munkaidőn túli",     s: "amit az iroda elszalasztana, az nem vész el — munkaidőn túl, hétvégén és csúcsterhelésen is" },
      { ic: "bars",     t: "Riport és rálátás",                  s: "Ön végre látja: hány megkeresés jött be, milyen gyorsan válaszoltak, hány árajánlat van függőben, mi foglalt le, és mit hozott vissza az utánkövetés", lead: true },
    ],
  },
];
      ...
      <div className="wrap">
        <div className="dash__intro reveal">
          ...
          <p className="dash__p">
            ...
            és minden kiküldött árajánlatot utánkövet — a háttérben, az Ön meglévő
        ...
        <div className="sysframe reveal" data-delay="1">
          ...
          <div className="jrn__result reveal">
            ...
            <div className="jrn__result-txt">
              <b className="jrn__result-t">Több megrendelés — és Ön először látja, hogyan</b>
            </div>
          </div>
