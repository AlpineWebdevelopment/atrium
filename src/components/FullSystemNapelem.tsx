/* ATRIUM-EDIT KV5/KV6 — full system rebuilt for cégvezető napelem (solar) buyer.
   ...
   CAPS: 6 solar capabilities, unchanged structure from previous build. */
...
/* KV5 — three phases, solar-specific */
const PHASES: {
...
export default function FullSystemNapelem() {
  return (
          ...
          <div className="sysframe__bar">
            <div className="sysframe__bar-top">
              ...
              <span className="sysframe__live">
                ...
                Minden ajánlatkérés egy helyen · egy sem vész el
              </span>
            </div>
