/* ATRIUM-EDIT NR7-physio — full-system block removed; replaced with focused course-tracker block.
...
const ITEMS = [
  {
    b: "Figyeli, ki marad ki",
    s: "Észreveszi, ki nem foglalt új időpontot a kezelési sorban.",
  },
  {
    b: "Időben visszahívja",
    s: "Magyarul megkeresi a következő alkalomra, mielőtt elmarad.",
  },
  {
    b: "Foglal és emlékeztet",
    s: "Időpontot ad a naptárba, és emlékeztetőt küld.",
  },
];
    ...
    <section className="sys" id="rendszer-teljes">
      <div className="wrap">
        <div className="dash__intro reveal">
          <span className="dash__eyebrow"><span className="newtag">AI folyamatkövető</span> Hogyan működik</span>
          <h2 className="dash__h">Mit csinál a folyamatkövető?</h2>
        </div>
