/* Physio full system — teal-blue / healing-green / amber phase palette */
...
const ICONS: Record<string, React.ReactNode> = {
  ...
  clipboard: <g><rect x="9" y="2" width="6" height="4" rx="1" /><path d="M5 4h2a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2h2a2 2 0 0 1 2 2v13a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z" /><path d="M9 12l2 2 4-4" /></g>,
};

const CAPS = [
  { ic: "mic", c: "#4A9EB8", t: "Hang-AI", d: "Természetes magyar beszéd — fogadja a hívásokat és visszahív." },
  { ic: "chat", c: "#628FBC", t: "Szöveges AI", d: "SMS, WhatsApp, e-mail és webchat — egy helyen kezelve." },
  { ic: "send", c: "#6B9E5E", t: "Proaktív megkeresés", d: "Nem csak válaszol — magától keresi meg a régi pácienseket." },
  { ic: "db", c: "#62BCAC", t: "Egységes páciens-memória", d: "Minden csatornán emlékszik a páciensre és az előző kezelésre." },
  { ic: "qualify", c: "#628FBC", t: "Kvalifikáció", d: "Felteszi a fontos kérdéseket: kezelés típusa, terapeuta, időpont." },
  { ic: "refresh", c: "#6DBC61", t: "Naptár- és CRM-szinkron", d: "A meglévő eszközeihez kötve, valós időben." },
  { ic: "bars", c: "#6B9E5E", t: "Riport", d: "Havi kimutatás: teli naptár, no-show arány, bevétel." },
...
function VizMegtartas() {
  ...
  return (
    <svg className="tsr__svg" viewBox="0 0 300 210" role="img" aria-label="Megtartás — a páciens újra és újra visszatér">
...
const PHASES = [
  {
    n: "01", name: "Megkeresés", cap: "az első hívástól a foglalásig", c: "#4A9EB8", Viz: VizMegkereses,
    steps: [
      { ic: "phone", t: "Hívásfogadás", s: "minden hívást felvesz, kezelés közben és zárás után is" },
      { ic: "chat", t: "Azonnali válasz", s: "e-mailen, webchat-en, SMS-en percek alatt visszaír" },
      { ic: "qualify", t: "Kezelési szűrés", s: "felteszi a fontos kérdéseket: kezelés típusa, terapeuta, időpont" },
      { ic: "handoff", t: "Élő átadás", s: "ha személyes döntés kell, azonnal kapcsol" },
    ],
  },
  {
    n: "02", name: "Foglalás", cap: "időpont, megerősítve", c: "#6B9E5E", Viz: VizFoglalas,
    steps: [
      { ic: "calendar", t: "Időpontfoglalás", s: "egyenesen a naptárba, a megfelelő terapeutához" },
      { ic: "confirm", t: "Visszaigazolás", s: "azonnal visszaigazolja a foglalást" },
      { ic: "bell", t: "Emlékeztető", s: "24 és 2 órával előtte értesíti a pácienst" },
      { ic: "reschedule", t: "Várólistakezelés", s: "lemondás esetén azonnal értesíti a várólistán lévőket" },
    ],
  },
  {
    n: "03", name: "Megtartás", cap: "páciensek visszahozva", c: "#9E7B4A", Viz: VizMegtartas,
    steps: [
      { ic: "callback", t: "No-show visszahívás", s: "visszaszerzi az elmaradt kezelési alkalmakat" },
      { ic: "star", t: "Értékelés", s: "elégedett pácienst Google-értékelésre kér" },
      { ic: "refresh", t: "Reaktiválás", s: "régen nem járt pácienseket a kezelési folyamat folytatásához hívja vissza" },
      { ic: "users", t: "Ajánláskérés", s: "az elégedett pácienst ajánlásra kéri — új páciens a meglévőből" },
    ],
  },
];
...
const CHANNELS: { n: string; c: string; ic: React.ReactNode }[] = [
  ...
  { n: "E-mail", c: "#4A9EB8", ic: <g><rect x="3" y="5" width="18" height="14" rx="2" /><path d="M3 7l9 6 9-6" /></g> },
  { n: "Webchat", c: "#62BCAC", ic: <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /> },
];

export default function FullSystemPhysio() {
  return (
    <section className="sys" id="rendszer-teljes">
      <div className="wrap">
        <div className="dash__intro reveal">
          ...
          <p className="dash__p">
            Az Atrium egy magyar nyelvű, AI-alapú rendszer gyógytornász
            és fizioterapeuta rendelőknek: minden csatornán ugyanaz a
            közös memória dolgozik, és végigkíséri a pácienst az első
            hívástól a visszatérő törzsvendéggé válásig — a háttérben,
            az Ön meglévő naptárához kötve.
          </p>
          <p className="sys__howline">
            Hogyan működik? AI-ügynökök kezelik a hang- és szöveges
            kommunikációt, természetes magyar nyelven — a csapatának
        ...
        <div className="sysframe reveal" data-delay="1">
          ...
          <div className="jrn__result reveal">
            ...
            <div className="jrn__result-txt">
              <b className="jrn__result-t">Teli naptár, több kezelés</b>
