/* Salon full system — rose/gold/teal phase palette */
...
const ICONS: Record<string, React.ReactNode> = {
  ...
  scissors: <g><circle cx="6" cy="6" r="3" /><circle cx="6" cy="18" r="3" /><path d="M20 4L8.12 15.88M14.47 14.48L20 20M8.12 8.12L12 12" /></g>,
  heart: <path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" />,
};

const CAPS = [
  { ic: "mic", c: "#BC6285", t: "Hang-AI", d: "Természetes magyar beszéd — fogadja a hívásokat és visszahív." },
  ...
  { ic: "qualify", c: "#628FBC", t: "Kvalifikáció", d: "Felteszi a fontos kérdéseket: kezelés típusa, mester, időpont." },
...
const PHASES = [
  {
    n: "01", name: "Megkeresés", cap: "az első hívástól a foglalásig", c: "#BC6285", Viz: VizMegkereses,
    steps: [
      ...
      { ic: "qualify", t: "Szolgáltatás szűrés", s: "felteszi a fontos kérdéseket: kezelés, mester, időpont" },
  ...
  },
  {
    ...
    steps: [
      { ic: "calendar", t: "Időpontfoglalás", s: "egyenesen a naptárba, a megfelelő mesterhez" },
  ...
  },
  {
    ...
    steps: [
      { ic: "callback", t: "No-show visszahívás", s: "visszaszerzi az elmaradt kezelést" },
...
const CHANNELS: { n: string; c: string; ic: React.ReactNode }[] = [
  ...
  { n: "Instagram", c: "#BC6285", ic: <g><rect x="3" y="3" width="18" height="18" rx="5" /><circle cx="12" cy="12" r="4" /><path d="M17.5 6.5h.01" /></g> },
...
export default function FullSystemSalon() {
  return (
      ...
      <div className="wrap">
        <div className="dash__intro reveal">
          ...
          <p className="dash__p">
            ...
            szépségszalonoknak: minden csatornán ugyanaz a közös memória
