/* ATRIUM-EDIT NR7-salon — full-system block removed; replaced with focused booking-assistant block.
   Removed: system intro paragraph, Hogyan működik line, channel chip row (Telefon·SMS·…·Webchat),
   01 Megkeresés / 02 Foglalás / 03 Megtartás funnel diagram, Teli naptár result line,
   integrations line, Mit tud a rendszer? capability grid (Hang-AI…0–24).
...
const ITEMS = [
  ...
  {
    b: "Időpontot ad",
    s: "Felajánlja a szabad időpontokat, és a megfelelő mesterhez foglal a naptárba.",
  },
  {
