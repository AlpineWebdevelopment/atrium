/* Vet full system — same three-phase journey, adapted for animal clinics */
...
function VizMegkereses() {
  ...
  return (
    <svg className="tsr__svg" viewBox="0 0 300 210" role="img" aria-label="Megkeresés — minden hívás egy minősített érdeklődővé">
      ...
      <text className="tsr__viz-lbl" x="226" y="160" textAnchor="middle">szűrve, minősítve</text>
    </svg>
  );
}
...
const PHASES = [
  {
    n: "01", name: "Megkeresés", cap: "az első hívástól a vizsgálatig", c: "#9662BC", Viz: VizMegkereses,
    steps: [
      { ic: "phone", t: "Hívásfogadás", s: "minden hívást felvesz, éjjel és hétvégén is" },
      { ic: "qualify", t: "Sürgősségi szűrés", s: "azonnal kiszűri, melyik eset azonnali ellátást igényel" },
      { ic: "chat", t: "Gazdai kvalifikáció", s: "felteszi a fontos kérdéseket: faj, tünetek, kor" },
      { ic: "handoff", t: "Élő átadás", s: "ha az állatorvos azonnal kell, rögtön kapcsol" },
    ],
  },
  {
    n: "02", name: "Foglalás", cap: "vizsgálat, megerősítve", c: "#628FBC", Viz: VizFoglalas,
    steps: [
      ...
      { ic: "bell", t: "Emlékeztető", s: "oltás, visszaellenőrzés előtt értesíti a gazdát" },
      { ic: "reschedule", t: "Átütemezés", s: "ha változik a terv, átteszi vagy lemondja az időpontot" },
    ],
  },
  {
    n: "03", name: "Megtartás", cap: "páciensek visszahozva", c: "#6DBC61", Viz: VizMegtartas,
    steps: [
...
export default function FullSystemVet() {
  return (
