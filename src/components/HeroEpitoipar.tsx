/* ATRIUM-EDIT KV1/KV2/KV3 — construction hero.
   Static headline (no typewriter). Channels trimmed to phone/SMS/email/WhatsApp.
   DAY entries rewritten for on-site / árajánlat-utánkövetés context. */
"use client";
...
const DAY = [
  ...
  { time: "07:30", k: "phone", c: "#628FBC", t: "3 reggeli hívást fogadott a rendszer, amíg Ön az első munkára ért." },
  ...
  { time: "12:20", k: "refresh", c: "#BCA162", t: "Egy 3 hete kiküldött ajánlat utánkövetése elindult." },
  ...
  { time: "21:30", k: "moon", c: "#628FBC", t: "3 visszahívott érdeklődő, 2 lefoglalt felmérés. Nyugodtan alszik." },
];
      ...
      <div className="wrap">
        <div className="hero__grid">
          ...
          <div className="hero__content reveal reveal--instant visible">
            {/* ATRIUM-EDIT KV1 — construction category line */}
            <span className="hero__eyebrow">Értékesítési rendszer építőipari cégeknek.</span>
            {/* ATRIUM-EDIT KV2 — static construction headline; no typewriter needed */}
            <h1 className="hero__title">
              A rendszer, amely akkor is értékesít, amikor Ön az építkezésen van.
            </h1>
            {/* ATRIUM-EDIT KV3 — construction subhead */}
            <p className="hero__sub">
              Az Atrium egy magyar nyelvű, AI-alapú értékesítési rendszer
              építőipari cégeknek — minden hívást fogad, minden árajánlatot
              utánkövet, és minden érdeklődőt visszahív, amíg Ön a munkán van.
            </p>
          ...
          {/* Right — a day in the life on a construction company */}
          <div className="canvas reveal reveal--instant visible" aria-hidden="true">
            ...
            <div className="canvas__stage canvas__stage--con">
              <div className="hcon__head2">
                <span className="hcon__title"><i /> Amíg Ön az építkezésen van</span>
              ...
              <div className="hcon__foot">Ön a munkán van — a rendszer közben mindenre figyel.</div>
            </div>
          </div>
        </div>
      </div>
