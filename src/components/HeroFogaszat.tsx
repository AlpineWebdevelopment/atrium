/* ATRIUM-EDIT FG1/FG2/FG3/FG8 — dental hero, owner-operator frame.
   FG2: static headline — no typewriter.
   FG8: "Egy páciens útja" — 6-step patient lifecycle, ending on recall. 3/3 col split.
...
/* FG8 — Egy páciens útja; 6 steps, 3/3 split; refresh (recall) uses signal color for emphasis */
const JOURNEY = [
  { k: "phone",    c: "#6DBC61", step: "Hívás",       t: "Egy páciens hív, zárás után, fájó foggal." },
  ...
  { k: "calendar", c: "#628FBC", step: "Lefoglalva",   t: "Időpont a naptárban, a páciensnek visszaigazolva." },
  { k: "bell",     c: "#9662BC", step: "Emlékeztetve", t: "Az időpont előtt, hogy meg is jelenjen." },
  { k: "refresh",  c: "#2D9B7F", step: "Visszahívva",  t: "Fél év múlva, amikor a kontroll esedékes, még mielőtt elsodródna." },
];

export default function HeroFogaszat() {
      ...
      <div className="wrap">
        <div className="hero__grid">
          ...
          <div className="hero__content reveal reveal--instant visible">
            {/* ATRIUM-EDIT FG1 */}
            <span className="hero__eyebrow">Értékesítési rendszer fogászati rendelőknek.</span>
            {/* ATRIUM-EDIT FG2 — static; no typewriter */}
            <h1 className="hero__title">
              Minden páciens. Minden hívás. Minden órában.
            </h1>
            {/* ATRIUM-EDIT FG3 */}
            <p className="hero__sub">
              Az Atrium egy magyar nyelvű, AI-alapú értékesítési rendszer
              fogászati rendelőknek: minden hívást fogad, a sürgős eseteket
              rangsorolja, a rutin időpontokat lefoglalja, és visszahívja a
              pácienseket, mielőtt lemaradnának a kontrollról.
            </p>
          ...
          {/* Right — FG8: Egy páciens útja (illustrative), 6 steps, 3/3 split */}
          <div className="canvas reveal reveal--instant visible" aria-hidden="true">
            <div className="canvas__bar">
              ...
              <span className="canvas__bar-label">atrium · egy páciens útja</span>
            </div>
            <div className="canvas__stage canvas__stage--con">
              <div className="hcon__head2">
                <span className="hcon__title"><i /> Egy páciens útja</span>
              ...
              <div className="hcon__foot">Minden páciens egy évekig tartó kapcsolat. Egy sem vész el.</div>
            </div>
          </div>
        </div>
      </div>
