...
const DAY = [
  ...
  { time: "07:30", k: "calendar", c: "#C4705A", t: "Reggeli közben 3 új időpont futott be a hétre." },
  { time: "08:15", k: "webchat", c: "#62BCAC", t: "Egy vendég 30 mp alatt választ kapott a kezeléssel kapcsolatban." },
  { time: "09:40", k: "phone", c: "#628FBC", t: "Manikűrnél van — közben 4 hívást is felvett a rendszer." },
  ...
  { time: "13:30", k: "refresh", c: "#C4705A", t: "Egy féléve nem járt vendég visszahíva a szezonális ajánlathoz." },
  ...
  { time: "20:15", k: "home", c: "#C4705A", t: "Ön otthon pihen — a rendszer dolgozik tovább." },
  { time: "21:30", k: "moon", c: "#628FBC", t: "Tele naptár, 0 elszalasztott hívás. Nyugodtan alszik." },
];

export default function HeroKormos() {
        ...
        <div className="hero__grid">
          ...
          <div className="canvas reveal reveal--instant visible" aria-hidden="true">
            <div className="canvas__bar">
              ...
              <span className="canvas__bar-label">atrium · egy nap a körmös szalonban</span>
            </div>
