/* ATRIUM-EDIT KV1/KV2/KV3 — napelem (solar) hero.
   Static headline (no typewriter). Channels trimmed to phone/SMS/email/WhatsApp.
   DAY entries rewritten for paid-lead response / ajánlat-utánkövetés context. */
"use client";
...
const DAY = [
  { time: "06:50", k: "callback", c: "#6DBC61", t: "Még alszik — a 2 éjjeli ajánlatkérés már visszahíva, a 3. reggelre egyeztetve." },
  { time: "07:30", k: "phone", c: "#628FBC", t: "3 reggeli ajánlatkérést fogadott a rendszer, amíg Ön az első tetőre ért." },
  { time: "08:15", k: "calendar", c: "#9662BC", t: "Helyszíni felmérés egyenesen a naptárba — Ön nélkül." },
  ...
  { time: "12:20", k: "refresh", c: "#BCA162", t: "Egy 3 hete kiküldött napelemes ajánlat utánkövetése elindult." },
  { time: "13:30", k: "callback", c: "#6DBC61", t: "2 elmaradt helyszíni felmérés újraegyeztetve — mindkettő elfogadta." },
  { time: "15:10", k: "bell", c: "#62BCAC", t: "Holnapi helyszíni felmérésre emlékeztetők elküldve." },
  { time: "16:45", k: "star", c: "#BCA162", t: "Egy elégedett megbízótól a rendszer értékelést kért." },
  { time: "18:00", k: "bars", c: "#6DBC61", t: "Nap végén egy pillantás a telefonján — a rendszer megmutatja, mit hozott a mai nap." },
  { time: "20:15", k: "home", c: "#9662BC", t: "Ön otthon, a családdal — a rendszer dolgozik tovább." },
  { time: "21:30", k: "moon", c: "#628FBC", t: "A vasárnap esti ajánlatkérésre is azonnal válasz ment. Nyugodtan alszik." },
];

export default function HeroNapelem() {
      ...
      <div className="wrap">
        <div className="hero__grid">
          ...
          <div className="hero__content reveal reveal--instant visible">
            {/* ATRIUM-EDIT KV1 — solar category line */}
            <span className="hero__eyebrow">Értékesítési rendszer napelemes cégeknek.</span>
            {/* ATRIUM-EDIT KV2 — static solar headline; no typewriter needed */}
            <h1 className="hero__title">
              A rendszer, amely akkor is válaszol, amikor Ön épp a tetőn van.
            </h1>
            {/* ATRIUM-EDIT KV3 — solar subhead */}
            <p className="hero__sub">
              Az Atrium egy magyar nyelvű, AI-alapú értékesítési rendszer
              napelemes cégeknek — minden ajánlatkérésre azonnal reagál, minden
              árajánlatot utánkövet, és minden érdeklődőt visszahív, hogy a
              kifizetett lead ne hűljön ki, amíg Ön a felmérésen van.
            </p>
          ...
          {/* Right — a day in the life of a solar company */}
          <div className="canvas reveal reveal--instant visible" aria-hidden="true">
            ...
            <div className="canvas__stage canvas__stage--con">
              <div className="hcon__head2">
                <span className="hcon__title"><i /> Amíg Ön a tetőn van</span>
              ...
              <div className="hcon__foot">Ön a felmérésen van — a rendszer közben mindenre figyel.</div>
            </div>
          </div>
        </div>
      </div>
