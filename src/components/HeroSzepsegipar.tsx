/* ATRIUM-EDIT SZ1/SZ2/SZ3 — broad beauty hero.
   SZ1: category eyebrow broadened to cover szalon / körmös / kozmetikus.
   SZ2/SZ3: DM-booking framing carried from salon reframe.
   Day timeline: DM-first beats; qualify-out beat removed (fill, don't filter). */
"use client";
...
/* Canvas channel icons — phone, messenger, instagram, email, webchat (honest confirmed set) */
const CHANNELS = [
  { k: "phone",     c: "#6DBC61" },
  { k: "messenger", c: "#628FBC" },
  { k: "instagram", c: "#9E6B9E" },
];
...
export default function HeroSzepsegipar() {
      ...
      <div className="wrap">
        <div className="hero__grid">
          <div className="hero__content reveal reveal--instant visible">
            {/* ATRIUM-EDIT SZ1 — broad beauty category; szalon / körmös / kozmetikus */}
            <span className="hero__eyebrow">Szépségszalonoknak, körmösöknek, kozmetikusoknak.</span>
            {/* ATRIUM-EDIT SZ2 */}
          ...
          {/* Right — day timeline, DM-first beats */}
