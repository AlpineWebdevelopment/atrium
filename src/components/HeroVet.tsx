...
const PHRASES = [
  ...
  "elmaradt oltások miatt",
  "kihűlt gazdák miatt",
  "elfelejtett páciensek miatt",
];
      ...
      <div className="wrap">
        <div className="hero__grid">
          <div className="hero__content reveal reveal--instant visible">
            <span className="hero__eyebrow">Állatorvosi rendelőknek</span>
            <h1 className="hero__title">
              Ne veszítsen több gazdát
          ...
          <div className="canvas reveal reveal--instant visible" aria-hidden="true">
            <div className="canvas__bar">
              ...
              <span className="canvas__bar-label">atrium · egy nap az állatorvosi rendelőben</span>
            </div>
            <div className="canvas__stage canvas__stage--con">
              <div className="hcon__head2">
                <span className="hcon__title"><i /> Amíg Ön gyógyít</span>
