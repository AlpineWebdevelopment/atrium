...
const STEPS = [
  ...
  },
  {
    n: "02",
    t: "A kérdéstérkép.",
    d: "Megkapja a valós kérdések listáját az Ön szakmájából, mellé az ajánlat-koncepciókat kész szövegekkel, a céloldal vázlatát és az árat az Ön számaiból. Kötelezettség nélkül; Ön dönti el, indítjuk-e.",
