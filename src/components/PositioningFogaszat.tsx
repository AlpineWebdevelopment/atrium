/* ATRIUM-EDIT FG4/FG5 — dental problem section.
   FG4: two leaks — the obvious (missed call) and the hidden (drifting base).
   FG5: route-not-filter framing line placed at the end of this section.
...
export default function PositioningFogaszat() {
  return (
