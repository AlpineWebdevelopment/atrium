export default function PositioningPhysio() {
  return (
    <section className="pos">
      <div className="wrap">
        <div className="pos__inner reveal">
          ...
          <p className="pos__p">
            A páciens néhány alkalom után jobban lesz, és elmarad, vele együtt
            pedig a hátralévő kezelések és a hozzájuk tartozó bevétel is. Nem új pácienst
          ...
          <p className="pos__niche">
            ...
            klinikáig: mindegyiknek a saját rendszere, a saját
            kezelési típusaihoz és protokolljához igazítva.
          </p>
        </div>
      </div>
    </section>
