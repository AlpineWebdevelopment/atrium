/* The one named product: the AI qualifier CRM — nail / körmös edition.
   Duplicated from QualifierCrmSalon; mester→körmös, accent color updated. */
...
function GfxTuned() {
  ...
  return (
    <svg viewBox="0 0 260 160" role="img" aria-label="Minden körmösre van megoldásunk">
...
const BENEFITS = [
  { b: "Szalonára szabva", s: "kezelések, körmösök és kapacitás szerint konfigurálva", c: "#C4705A", Gfx: GfxTuned },
