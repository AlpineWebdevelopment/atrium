...
/* Építőipar leak section — the four revenue leaks a typical kivitelező runs.
...
const PAINS = [
  {
    ...
    desc:
      "A komoly munkák telefonon indulnak — gyakran este, hétvégén vagy foglalt vonal mellett. Aki hangpostát kap, nem vár: a következő kivitelezőt hívja. Egy elnyert munka már sokszorosát hozza a rendszer árának.",
    metrics: [
      { k: "Hívás érkezik", c: "var(--ink)", v: "Munkaidőn kívül", d: "este, hétvégén, foglalt vonalon" },
      { k: "A vonal", c: "var(--ink)", v: "Hangposta", d: "Ön az építkezésen van" },
      { k: "A hívó", c: "var(--stone)", v: "Tovább lép", d: "a következő céget hívja" },
      { k: "A munka", c: "var(--viz-red)", v: "Elveszik", d: "máshol köt ki" },
    ],
    loss: { v: "≈ 4 000 000 Ft", per: "/ hó", math: "~15 hívás havonta munkaidőn kívül — egy elnyert munka ~4 000 000 Ft" },
  },
  {
    tab: "Lassú utánkövetés",
    desc:
      "A weboldalról és hirdetésből érkező érdeklődő gyorsan dönt. Aki előbb visszahív, az viszi a felmérést. Ha az első válasz csak másnap jön, a gyorsabb versenytárs már ott járt.",
    metrics: [
  ...
  },
  {
    ...
    desc:
      "Az árajánlat kiment — de senki nem kíséri végig. Az ügyfél halogat, aztán elfelejti, vagy mást választ. A majdnem-kész üzlet csendben elveszik. A rendszer utánkövet: emlékeztet, kérdez, lezár. Ez a legnagyobb tétel.",
    metrics: [
    ...
    loss: { v: "≈ 8 000 000 Ft", per: "/ hó", math: "~8–10 utánkövetetlen árajánlat — 1–2 visszahozva ~4–8M Ft munka" },
  },
  {
    tab: "Elmaradt felmérés",
    desc:
      "A helyszíni felmérés a munka kezdete — de emlékeztető nélkül elmarad vagy üres címre fut ki a kiszállás. Elpazarolt idő, csúszó vagy elveszett munka. A rendszer emlékeztet és újraegyeztet.",
    metrics: [
      ...
      { k: "A munka", c: "var(--viz-red)", v: "Csúszik", d: "vagy mást hív" },
    ],
  ...
  return (
    <div className="quo">
      ...
      <div className="quo__sum">
        ...
        <span className="quo__sum-note">a majdnem-kész munka csendben elveszik</span>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="cal-wrap">
      ...
      <div className="cal__sum">
        ...
        <span className="cal__sum-note">emlékeztető nélkül a munka csúszik vagy elmarad</span>
      </div>
    </div>
  );
}
...
export default function RealtimeDashboardEpitoipar() {
    ...
    <section className="dash">
      <div className="wrap">
        <div className="dash__intro reveal">
          ...
          <p className="dash__p">
            A legtöbb építőipari cég nem munkahiánytól szenved — hanem attól,
            hogy a megkeresések egy része elvész útközben: elszalasztott hívás,
            lassú visszajelzés, utánkövetetlen árajánlat, elmaradt felmérés. A
            rendszert az Ön működésére szabjuk, és azt a lyukat zárja be,
            amelyik Önnél a legnagyobb.
          </p>
          <p className="dash__exnote">
            Az alábbi számok illusztratív példák egy átlagos kivitelezőre —
            élesben az Ön valós számaival (megkeresés, átlagos munka, fedezet,
            záródás) töltjük ki.
          </p>
        </div>
