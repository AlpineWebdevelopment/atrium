...
const PAINS = [
  {
    ...
    desc: "Manikűr, pedikűr, géllakkozás közben nem lehet felvenni a telefont. A vendég nem vár — a következő szalont hívja.",
    metrics: [
  ...
  },
  {
    ...
    metrics: [
      { k: "Időpont", c: "var(--ink)", v: "10:00", d: "manikűr, pedikűr, géllakkozás" },
...
function GfxFunnel() {
  ...
  const color = (st: string) => (st === "v" ? "#C4705A" : st === "k" ? "#010E1E" : "rgba(1,14,30,0.13)");
  ...
  return (
    <div className="qual">
      ...
      <div className="qual__legend">
        ...
        <span className="qual__leg"><i className="qual__leg-dot" style={{ background: "#C4705A" }} />Visszatérő vendég</span>
  ...
  return (
    <div className="dash__chart">
      <svg className="dash__svg" viewBox="0 0 1000 190" preserveAspectRatio="none">
        <defs>
          <linearGradient id="gAnsK" x1="0" y1="0" x2="1" y2="0">
            <stop offset="0%" stopColor="#010E1E" />
            <stop offset="55%" stopColor="#010E1E" />
            <stop offset="100%" stopColor="#C4705A" />
          </linearGradient>
        </defs>
        {[44, 92, 140].map((y) => (
        ...
        {bars.map((h, i) => {
          ...
          return <rect key={i} x={x} y={baseY - h} width={w} height={h} rx="3" fill={after ? "rgba(196,112,90,0.55)" : "rgba(1,14,30,0.18)"} />;
        })}
        <path d="M36,95 C90,58 150,40 215,52 C285,64 320,108 385,108 C450,108 480,86 545,90 C610,94 650,74 690,84" fill="none" stroke="url(#gAnsK)" strokeWidth="3" strokeLinecap="round" />
        <circle cx="690" cy="84" r="5" fill="#C4705A" stroke="var(--bone)" strokeWidth="2.5" />
      </svg>
...
function GfxCooling() {
  return (
    <div className="dash__chart">
      <svg className="dash__svg" viewBox="0 0 1000 190" preserveAspectRatio="none">
        <defs>
          <linearGradient id="gCoolK" x1="0" y1="0" x2="1" y2="0">
            <stop offset="0%" stopColor="#010E1E" />
            <stop offset="55%" stopColor="#8C8579" />
            <stop offset="100%" stopColor="#C46C64" />
          </linearGradient>
          <linearGradient id="gCoolFillK" x1="0" y1="0" x2="0" y2="1">
        ...
        <path d="M60,52 C220,58 380,94 560,128 C720,158 850,168 950,172 L950,190 L60,190 Z" fill="url(#gCoolFillK)" />
        <path id="coolPathK" d="M60,52 C220,58 380,94 560,128 C720,158 850,168 950,172" fill="none" stroke="url(#gCoolK)" strokeWidth="3" strokeLinecap="round" />
...
export default function RealtimeDashboardKormos() {
    ...
    <section className="dash">
      <div className="wrap">
        <div className="dash__intro reveal">
          ...
          <p className="dash__p">
            A legtöbb körmös szalon nem vendéghiánytól szenved — hanem
