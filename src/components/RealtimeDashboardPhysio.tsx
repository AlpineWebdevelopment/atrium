...
const PAINS = [
  {
    ...
    metrics: [
      ...
      { k: "A páciens", c: "var(--stone)", v: "Nem vár", d: "máshova hív" },
      { k: "A foglalás", c: "var(--viz-red)", v: "Elveszik", d: "elveszett bevétel" },
    ],
    loss: { v: "≈ 420 000 Ft", per: "/ hó", math: "~7 elveszett páciens × ~60 000 Ft átlagos éves páciensértéke" },
  },
  {
    tab: "No-show-k",
    ...
    metrics: [
      ...
      { k: "A kezelési idő", c: "var(--stone)", v: "Üresen marad", d: "senki nem tölti fel" },
      { k: "Emlékeztető", c: "var(--viz-red)", v: "Nincs", d: "nincs rá kapacitás" },
    ],
    loss: { v: "≈ 280 000 Ft", per: "/ hó", math: "~10 no-show × ~28 000 Ft kezelési díj" },
  },
  {
    tab: "Lassú visszahívás",
    desc: "Egy páciens foglalási érdeklődése percek alatt kihűl. Ha az első válasz csak órákon belül jön, addigra már más rendelőnél foglalt.",
    metrics: [
      { k: "Foglalási igény", c: "var(--ink)", v: "13:45", d: "e-mail, webchat, SMS" },
      { k: "Első válasz", c: "var(--stone)", v: "3 óra múlva", d: "amikor épp jut rá idő" },
      { k: "A páciens", c: "var(--stone)", v: "Más rendelőben", d: "már foglalt máshol" },
      { k: "A hirdetési költség", c: "var(--viz-red)", v: "Elment", d: "bevétel nem lett belőle" },
    ],
    loss: { v: "≈ 340 000 Ft", per: "/ hó", math: "~6 kihűlt érdeklődő × ~56 000 Ft átlagos éves páciensértéke" },
  },
  {
    ...
    metrics: [
      ...
      { k: "Az idősáv", c: "var(--stone)", v: "Üresen marad", d: "bevétel elveszik" },
      { k: "Visszahívás", c: "var(--viz-red)", v: "Nincs", d: "nincs kapacitás rá" },
    ],
    loss: { v: "≈ 200 000 Ft", per: "/ hó", math: "~7 töltetlen lemondás × ~28 000 Ft kezelési díj" },
  },
];
...
function GfxFunnel() {
  ...
  const color = (st: string) => (st === "v" ? "#4A9EB8" : st === "k" ? "#010E1E" : "rgba(1,14,30,0.13)");
  ...
  return (
    <div className="dash__chart">
      <svg className="dash__svg" viewBox="0 0 1000 190" preserveAspectRatio="none">
        <defs>
          <linearGradient id="gAnsP" x1="0" y1="0" x2="1" y2="0">
            <stop offset="0%" stopColor="#010E1E" />
            <stop offset="55%" stopColor="#010E1E" />
            <stop offset="100%" stopColor="#4A9EB8" />
          </linearGradient>
        </defs>
        {[44, 92, 140].map((y) => (
        ...
        <path d="M36,95 C90,58 150,40 215,52 C285,64 320,108 385,108 C450,108 480,86 545,90 C610,94 650,74 690,84" fill="none" stroke="url(#gAnsP)" strokeWidth="3" strokeLinecap="round" />
        <circle cx="690" cy="84" r="5" fill="#4A9EB8" stroke="var(--bone)" strokeWidth="2.5" />
      </svg>
...
function GfxCooling() {
  return (
    <div className="dash__chart">
      <svg className="dash__svg" viewBox="0 0 1000 190" preserveAspectRatio="none">
        <defs>
          <linearGradient id="gCoolP" x1="0" y1="0" x2="1" y2="0">
            <stop offset="0%" stopColor="#010E1E" />
            <stop offset="55%" stopColor="#8C8579" />
            <stop offset="100%" stopColor="#C46C64" />
          </linearGradient>
          <linearGradient id="gCoolFillP" x1="0" y1="0" x2="0" y2="1">
        ...
        <path d="M60,52 C220,58 380,94 560,128 C720,158 850,168 950,172 L950,190 L60,190 Z" fill="url(#gCoolFillP)" />
        <path id="coolPathP" d="M60,52 C220,58 380,94 560,128 C720,158 850,168 950,172" fill="none" stroke="url(#gCoolP)" strokeWidth="3" strokeLinecap="round" />
  ...
  return (
    <div className="cal-wrap">
      ...
      <div className="cal__sum">
        ...
        <span className="cal__sum-item"><i className="cal__sum-dot cal__sum-dot--red" />{lost} üres idősáv</span>
...
export default function RealtimeDashboardPhysio() {
