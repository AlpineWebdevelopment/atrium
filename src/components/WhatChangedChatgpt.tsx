/* "Mi változott" — the dated facts about ChatGPT Ads in Hungary as three
   hairline-divided fact columns. Monochrome, line icons; the only emphasis
...
const FACTS = [
  ...
  },
  {
    ...
    ico: <g><circle cx="12" cy="12" r="8.5" /><path d="M9 12a3 3 0 0 1 3-3M12 15v.01" /><path d="M12 12v-.5" /></g>,
  },
  {
