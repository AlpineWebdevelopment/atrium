/* ATRIUM-EDIT AV9/AV10 — vet pricing + base ROI framing.
   AV9: "A nagyobb pénz a meglévő bázisban van." — the hidden lever.
   AV10: value-based, no price shown, meeting-first motion.
   Honest limit: "nem minden elmaradt gazdi hozható vissza" is intentionally on the page. */

const STEPS = [
  {
    n: "01",
    t: "Megbeszélés",
    d: "30 perces hívás — megnézzük az aktív páciensek számát, az egy kedvencre jutó éves értéket, és hogy a bázisból hányan maradtak le az oltási és szűrési rendről.",
  },
  {
    n: "02",
    t: "Diagnózis",
  ...
  },
  {
    ...
    d: "Az árat az aktív páciensek számából, az egy kedvencre jutó éves értékből és a lecsúszott páciensek becsült arányából számítjuk. Nincs rögzített árlista.",
  },
  {
    n: "04",
    t: "Elindítás",
      ...
      <div className="wrap">
        <div className="dash__intro reveal">
          ...
          <p className="dash__p">
            ...
            őszinték: nem minden elmaradt gazdi hozható vissza. Aki költség miatt
