/* ATRIUM-EDIT KV8/KV9 — cégvezető klíma pricing rebuild.
   KV9: value-based heading, built from their numbers, no list price.
   KV8: ROI framing around quote recovery (beszerelési érték), not call volume.
...
const STEPS = [
  ...
  },
  {
    ...
    d: "Nincs rögzített árlista. Az ajánlatot a beérkező megkeresések számából, a jellemző beszerelési értékből és az elvárt hatásból számítjuk.",
  },
  {
    n: "04",
    t: "Elindítás",
...
export default function WorkPricingKlima() {
  return (
