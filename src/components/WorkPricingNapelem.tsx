/* ATRIUM-EDIT KV8/KV9 — cégvezető napelem (solar) pricing rebuild.
   KV9: value-based heading, built from their numbers, no list price.
   KV8: ROI framing around quote recovery and paid-lead value, not call volume.
...
const STEPS = [
  ...
  },
  {
    n: "02",
    t: "Diagnózis",
    d: "Összerakjuk, hol szivárog a legtöbb bevétel: a kifizetett lead kihűlésénél, a lassú reakciónál, az irányításnál vagy az utánkövetésnél.",
  },
  {
    n: "03",
    t: "Ajánlat az Önök számaiból",
    d: "Nincs rögzített árlista. Az ajánlatot a beérkező ajánlatkérések számából, a lead-árból, a jellemző beszerelés értékéből és az elvárt hatásból számítjuk.",
  },
  {
    n: "04",
    t: "Elindítás",
...
export default function WorkPricingNapelem() {
  return (
